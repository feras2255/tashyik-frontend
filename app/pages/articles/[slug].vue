<script setup>
  ...
  const articleJsonLd = computed(() => {
    ...
    const img = a.og_image || a.featured_image_lg || a.featured_image;
...
<template>
  <div>
    <div class="bg-gray-50 min-h-screen w-full flex flex-col" v-if="article">
      <!-- Article Header -->
      <section
        class="relative bg-gradient-to-br from-brand-900 via-brand-800 to-brand-950 text-white pt-12 pb-12 md:pt-20 md:pb-16 overflow-hidden"
      >
        ...
        <div class="container relative z-10 max-w-4xl mx-auto px-4">
          ...
          <nav class="flex items-center gap-2 text-sm text-brand-200 mb-6">
            <NuxtLinkLocale :to="{ name: 'index' }" class="hover:text-white transition-colors static-color">{{
              $t('navigation.home')
            }}</NuxtLinkLocale>
            <svg class="w-4 h-4 rtl:rotate-180" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
            </svg>
            <NuxtLinkLocale to="/articles" class="hover:text-white transition-colors static-color">{{
          ...
          <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 md:p-8">
            ...
            <div class="flex items-center gap-3">
              ...
              <a
                ...
                class="flex items-center justify-center w-10 h-10 bg-gray-900 text-white rounded-lg hover:bg-gray-700 transition-colors"
