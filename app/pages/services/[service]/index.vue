  ...
  <section v-if="service" class="w-full px-2 pb-28 pt-6 md:px-4 md:pb-10 md:pt-8 lg:pb-12">
      ...
      <div class="mt-6 grid gap-8 lg:grid-cols-2 lg:items-center lg:gap-12">
        <div class="min-w-0">
          ...
          <div class="mt-5 flex flex-wrap items-center gap-3">
            ...
            >
              <svg class="h-4 w-4 fill-yellow-500 stroke-yellow-500" viewBox="0 0 18 17" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                <path
            ...
            <div class="inline-flex items-center gap-2 rounded-xl border border-gray-200 bg-white px-3 py-2 text-sm font-medium text-gray-800 shadow-sm">
        ...
        <div class="relative aspect-[4/3] w-full overflow-hidden rounded-2xl border border-gray-200 bg-gray-100 shadow-md md:rounded-3xl">
          ...
          <div v-else class="flex h-full w-full items-center justify-center text-gray-400" aria-hidden="true">
            <svg class="h-20 w-20" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1" stroke="currentColor">
    ...
    >
      <summary class="flex cursor-pointer list-none items-center justify-between gap-2 text-sm font-semibold text-gray-800">
        ...
        <svg class="h-5 w-5 shrink-0 text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
          ...
          <div class="hidden lg:block lg:sticky lg:top-24">
            <div class="rounded-2xl border border-gray-200 bg-gradient-to-b from-white to-brand-50/30 p-6 shadow-md">
              ...
              <ul class="mt-6 space-y-3 border-t border-dashed border-gray-200 pt-5 text-sm text-gray-500">
                <li class="flex gap-2">
                  <svg class="h-5 w-5 shrink-0 stroke-brand-500" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        ...
        <div class="flex gap-2">
          ...
          >
            <svg class="h-6 w-6 text-green-600" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
              <path fill-rule="evenodd" d="M12 4a8 8 0 0 0-6.895 12.06l.569.718-.697 2.359 2.32-.648l.379.243A8 8 0 1 0 12 4M2 12C2 6.477 6.477 2 12 2s10 4.477 10 10-4.477 10-10 10a9.96 9.96 0 0 1-5.016-1.347l-4.948 1.382 1.426-4.829-.006-.007-.033-.055A9.96 9.96 0 0 1 2 12" clip-rule="evenodd" />
