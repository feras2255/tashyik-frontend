      ...
      <div class="rounded-full w-12 h-12 flex items-center justify-center bg-brand-50 text-brand-400">
        ...
        >
          ...
          <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24">
            ...
            <path
              fill="currentColor"
              d="M9 8h6V6H9zM2 20v-5h4v1h2v-1h8v1h2v-1h4v5zm0-6v-4q0-.825.588-1.412T4 8h3V6q0-.825.588-1.412T9 4h6q.825 0 1.413.588T17 6v2h3q.825 0 1.413.588T22 10v4h-4v-2h-2v2H8v-2H6v2z"
            />
          </svg>
        </template>
        ...
        <template v-if="notification.type == 'new-order-extra'">
          ...
          <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24">
            ...
            <g fill="currentColor">
              ...
              />
              <path
                d="m10.076 8.64l-2.201-2.2V4.874a.75.75 0 0 0-.364-.643l-3.75-2.25a.75.75 0 0 0-.916.113l-.75.75a.75.75 0 0 0-.113.916l2.25 3.75a.75.75 0 0 0 .643.364h1.564l2.062 2.062z"
              />
              <path
                fill-rule="evenodd"
