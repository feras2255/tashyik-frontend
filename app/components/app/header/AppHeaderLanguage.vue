...
<template>
  <div class="relative" ref="dropdownRef">
    ...
    <!-- Dropdown menu -->
    <div v-show="isOpen" id="languageDropdown" class="absolute top-full end-0 z-50 mt-1 w-40 bg-white divide-y divide-gray-100 rounded-lg shadow-lg border border-gray-200">
      <ul class="p-2 space-y-1 text-gray-500" aria-labelledby="languageDropdownButton">
