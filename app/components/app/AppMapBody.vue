...
<template>
  <div class="relative rounded-xl overflow-hidden h-full min-h-[12rem]">
    <div v-if="loader" class="absolute bg-gray-100 w-full h-full flex items-center justify-center z-[1]">
      <AppSpinner class="w-8 h-8" />
    </div>
    <div class="w-full h-full min-h-[12rem]" ref="map"></div>
