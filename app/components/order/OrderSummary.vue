    ...
    <div class="flex flex-col gap-5 md:gap-6 p-1 md:p-2">
      ...
      <div class="flex flex-wrap items-center gap-2 justify-between">
        ...
        <div
          ...
          "
          class="inline-flex gap-2 items-center text-amber-600 stroke-amber-600"
        >
        ...
        <!-- Completed status -->
        <div v-else-if="order.status == 'completed'" class="inline-flex gap-2 items-center text-green-500 stroke-green-500">
