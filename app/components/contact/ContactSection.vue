<script setup>
  ...
  const { contact_info } = storeToRefs(layoutStore);
      ...
      <div class="flex flex-col md:grid grid-cols-2 gap-6">
          ...
          <form @submit.prevent="handleRequest" class="flex flex-col gap-5">
            ...
            <div>
              ...
              <textarea
                ...
                required
                rows="4"
                class="rounded-xl p-3 border-gray-200 w-full focus:ring-2 ring-brand-100 text-sm"
              ></textarea>
        ...
        <div class="flex flex-col gap-6">
          ...
          <div class="flex flex-col gap-5">
            <!-- Whatsapp -->
            <a
              v-if="contact_info?.whatsapp_link"
              :href="contact_info.whatsapp_link"
              target="_blank"
              rel="noopener noreferrer"
              class="bg-white rounded-lg shadow p-6 inline-flex gap-4 hover:bg-gray-50 transition-colors"
            >
              <svg
                class="w-12 h-12 p-3 rounded-lg bg-brand-50 fill-brand-500"
                viewBox="0 0 24 24"
                fill="none"
            ...
            <div v-if="contact_info?.phone_number" class="bg-white rounded-lg shadow p-6 inline-flex gap-4">
              <svg
                class="w-12 h-12 p-3 rounded-lg bg-brand-50 stroke-brand-500"
                viewBox="0 0 24 24"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
              >
          ...
          <div class="bg-brand-500 rounded-lg p-8 flex flex-col gap-5 text-center justify-center items-center">
            <svg
              class="w-12 h-12 p-3 rounded-lg bg-brand-50 text-brand-500 stroke-brand-500"
              viewBox="0 0 24 24"
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
            >
