export default {
  ...
  cities: {
    ...
    service_links_truncated:
      'Affichage de {shown} sur {total} services mis en avant dans cette liste. Parcourez toutes les catégories pour le catalogue complet.',
    ...
    service_in_city_default_bullet2: 'Réparation ou entretien selon les règles de sécurité.',
