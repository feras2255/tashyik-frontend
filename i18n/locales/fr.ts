export default {
  seo: {
    ...
    service_provider: {
      ...
      description:
        'Inscrivez-vous en tant que prestataire de services à domicile et proposez vos services de climatisation, électricité, plomberie, électroménager, menuiserie, peinture, satellite, nettoyage, lutte contre les nuisibles et aide à domicile en toute sécurité.',
    },
    categories: {
      title: 'Catégories',
      description:
        "Parcourez les catégories de services de maintenance à domicile : plomberie, électricité, climatisation et réparation d'appareils. Réservez rapidement un technicien certifié.",
    },
    services: {
      title: 'Services',
      description:
        'Parcourez tous les services de maintenance à domicile, recherchez le service dont vous avez besoin et réservez rapidement un technicien certifié.',
    },
    cities_index: {
    ...
    about: {
      ...
      description:
        "Une plateforme saoudienne spécialisée pour vous connecter à des techniciens certifiés pour tous vos services de maintenance, rapidement et en toute sécurité. Notre objectif : votre tranquillité d'esprit.",
    },
    contact: {
      title: 'Contactez-nous',
      description:
        'Notre équipe est prête à recevoir votre message et à vous répondre dans les plus brefs délais. Remplissez vos coordonnées et nous vous contacterons directement.',
    },
    home: {
      title: 'Tashyik | Réservez un technicien de maintenance à domicile certifié en Arabie Saoudite',
      description:
        "Réservez des techniciens de confiance pour la climatisation, la plomberie, l'électricité et les appareils électroménagers dans toutes les villes saoudiennes. Service rapide, garantie certifiée, tarifs transparents.",
    },
  },
  a11y: {
  ...
  services: {
    ...
    index_subtitle:
      'Recherchez les services Tashyik, filtrez par spécialité et réservez un technicien certifié sans parcourir les catégories.',
  ...
  service_provider: {
    h1: {
      ...
      description:
        'Vous avez des compétences en maintenance ? Rejoignez notre plateforme et commencez à recevoir des clients avec professionnalisme.',
    },
    h2: {
  ...
  articles: {
    seo: {
      ...
      description:
        "Lisez les derniers articles et obtenez des conseils sur l'entretien de la maison, le soin des appareils électroménagers et les meilleures pratiques pour entretenir votre habitation.",
    },
    hero: {
      title: 'Articles',
