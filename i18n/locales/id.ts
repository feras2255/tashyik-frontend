export default {
  ...
  home: {
    ...
    features: {
      title: 'Mengapa ribuan pelanggan mempercayai kami?',
      subtitle: 'Kami bangga atas kepercayaan ribuan pelanggan karena kami selalu berusaha memberikan layanan yang dapat diandalkan.',
      feature_1: {
        title: '+300',
        description: 'Layanan Rumah',
      },
      feature_2: {
        title: '3.800+',
        description: 'Teknisi Profesional',
      },
      feature_3: {
        title: '632.000+',
      ...
      feature_4: {
        title: '25+',
        description: 'Kota Tercover',
      },
      feature_5: {
        title: '4.8',
        description: 'Rata-rata Rating Pelanggan',
      },
    },
    reviews: {
  ...
  service_provider: {
    ...
    h2: {
      ...
      items: ['AC (Pemasangan – Perawatan – Pembersihan)', 'Listrik (Kabel – Perbaikan – Pemasangan Alat)', 'Pipa Air (Perawatan – Deteksi Kebocoran – Ekstensi)', 'Peralatan Rumah (Mesin Cuci – Kulkas – Oven – Microwave)', 'Pertukangan (Pintu – Furnitur – Kamar Tidur – Custom)', 'Pengecatan (Interior & Eksterior – Wallpaper)', 'Satelit/Parabola (Pemasangan – Pemrograman – Perawatan)', 'Pembersihan Rumah (Pembersihan Menyeluruh – Karpet)', 'Pengendalian Hama (Pestisida Aman dan Efektif)', 'Bantuan Rumah Tangga (Membersihkan, Merapikan, dan Dukungan Harian)'],
    },
