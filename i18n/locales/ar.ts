export default {
  ...
  footer: {
    description_1:
      'منصة "تشييك" الرائدة لحجز فني صيانة منزلية موثوق في دقائق! نوفر أفضل الفنيين المعتمدين في المملكة العربية السعودية لخدمات الكهرباء والسباكة والنجارة والتكييف، بالإضافة إلى أكثر من ',
