export default {
  seo: {
    ...
    service_provider: {
      title: 'سجل معنا كفني',
      description:
        'سجل كمقدم خدمة منزلية وقدم خدمات المكيفات، الكهرباء، السباكة، الأجهزة المنزلية، النجارة، الدهانات، الستالايت، التنظيف، مكافحة الحشرات والمساعدة المنزلية بسهولة وأمان.',
    },
    categories: {
      title: 'الأقسام',
      description:
        'تصفح أقسام خدمات الصيانة المنزلية, السباكة والكهرباء وصيانة المكيفات والأجهزة المنزلية. احجز فني صيانة منزلي بسرعة وبجودة مضمونة.',
    },
    services: {
      title: 'الخدمات',
    ...
    about: {
      title: 'من نحن',
      description:
        'منصة سعودية متخصصة في ربطك بفنيين معتمدين لجميع خدمات الصيانة المنزلية، بسرعة، أمان، وسهولة. هدفنا نريح بالك ونضمن جودة تليق ببيتك.',
    },
    contact: {
      title: 'تواصل معنا',
    ...
    home: {
      ...
      description:
        'احجز فنيين موثوقين لصيانة المكيفات، السباكة، الكهرباء، والأجهزة المنزلية في كل المدن السعودية. خدمة سريعة، ضمان معتمد، أسعار شفافة.',
    },
  },
  a11y: {
  ...
  footer: {
    description_1:
      'احجز فني صيانة منزلية موثوق في دقائق مع تشييك! نوفّر فنيين معتمدين في السعودية لخدمات الكهرباء، السباكة، النجارة، التكييف، الدهانات وأكثر من ',
    description_2: '1000 خدمة منزلية. +3,800 فني محترف في +90 مدينة | تقييم 4.8 ⭐ | دفع آمن بعد إتمام الخدمة وضمان ذهبي على كل خدمة.',
    our_apps: 'تطبيقتنا',
    ...
    copyright_suffix: 'خدمات صيانة منزلية في السعودية',
  ...
  guest: {
    login: {
      ...
      subtitle: 'أدخل رقم جوالك وسنرسل لك رمز التحقق عبر واتساب.',
      sign_in: 'إرسال رمز التحقق',
    ...
    verify_otp: {
      ...
      subtitle: 'أدخل رمز التحقق المرسل إلى واتساب على الرقم',
      otp_label: 'رمز التحقق',
      verify_button: 'تأكيد الرمز',
      resend_otp: 'إعادة إرسال الرمز',
      resend_in: 'إعادة الإرسال بعد {time}',
      expires_in: 'الرمز صالح لمدة {time}',
      change_phone: 'الرقم غير صحيح؟ غيّر رقم الهاتف',
      change_phone_submit: 'تحديث الرقم وإرسال رمز جديد',
    },
  },
  inputs: {
  ...
  service_provider: {
    h1: {
      ...
      description:
        'هل لديك مهارة في مجال الخدمات المنزلية وتبحث عن وسيلة سهلة للوصول إلى العملاء؟ انضم إلينا وابدأ في تقديم خدماتك بثقة واحترافية عبر منصتنا المتخصصة.',
    },
    h2: {
  ...
  order: {
    ...
    summary: {
      ...
      description: 'وصف المشكلة',
      visit_cost: 'رسوم خدمة',
      visit_fee_credit_note: 'هيتخصم {amount} {currency} لو اتضافت خدمات إضافية بـ {min} {currency} أو أكثر',
      subtotal: 'الإجمالي الفرعي',
      tax: 'الضريبة ({rate}%)',
      wallet_balance: 'رصيد المحفظة',
    ...
    completion: {
      ...
      reject: 'رفض الإكمال',
      reject_confirm: 'هل أنت متأكد من رفض إكمال الطلب؟',
    ...
    extra: {
      ...
      invoice: {
        ...
        visit_fee_credit: 'خصم رسوم الخدمة',
      },
    },
  },
  review: {
  ...
  about: {
    ...
    story: {
      title: 'قصتنـا',
      paragraph_1:
        'بدأنا تشييك بهدف تسهيل حياة الناس، وتقديم حل ذكي يجمـع كـل خدمـات الصيـانة المنزليـة فـي مكـان واحد. نؤمن أن الخدمة السريعة والمـوثوقـة تبـدأ من اختيـار الفنـي المنـاسب، وتنتهـي بـراحة العميـل.',
      paragraph_2:
        'رؤيتنا تتجـاوز مجـرد إصـلاح الأعطـال؛ نحـن نسعـى لبناء مجتمع تقني سعـودي يسـاهم فـي رفع جودة الحياة داخل كل منزل في المملكة، مـن خـلال تنظيـم خـدمات الصيـانة وتقـديمهـا عبر تطبيق واحـد. ورفع المعايير الاحترافية.',
    },
    features: {
      title: {
        part_1: 'ليش تختار',
    ...
    audience: {
      ...
      individuals: {
        title: 'أصحاب المنازل',
        description:
          'نخـدم أصحـاب المنـازل اللـي يبغـون راحـة البال، وما عندهم وقت يـدورون على فنـي أو يجـربـون أكـثر مـن مرة. مـن خـلال منصتنــا، تقــدر تطلـب خـدمـة الصيـانـة اللـي تحتـاجهـا بكـل سهـولة، ونـوصلك بفنييـن مـوثـوقيـن، ينـجزون الشغل باحترافيـة وفـي الـوقت المنـاسب، علـشـان بيتـك يظل دايمًا في أفضل حال.',
      },
      institutions: {
        title: 'المؤسسات',
        description:
          'نعـرف إن أي عطـل بسيـط ممـكن يـأثر علـى سـير العـمـل. علشـان كـذا نقـدّم للمـؤسسات حـلول صيـانـة تسـاعـدهـم يحافظون على استمرارية العمل بدون تعطيل، سواء كانت صيـانـة دوريـة أو طلبـات عاجلـة. نهتـم بالتنظيـم، والالتـزام،وجودة التنفيذ في كل مرة.',
      },
      service_providers: {
        title: 'الفنيين',
        description:
          'نـؤمـن أن الفنـي هـو قلـب الخـدمـة وأسـاس نجـاحهـا. نـوفــر للفـنييـن منـصـة تسـاعــدهم يـوصلــون لعـمـلاء حقيقيين، وتنظيـم واضـح للطلبـات، ودعـم يسهّـل عليهـم شغلهم اليومي. هـدفنـا إن الفنـي يركـز على شغـله، ويكـبر معنـا خطـوة بخطوة بثقة واستقرار.',
      },
    },
  },
  contact: {
