export default {
  seo: {
    ...
    service_provider: {
      ...
      description:
        'Register as a home service provider and offer AC, electricity, plumbing, home appliances, carpentry, painting, satellite, cleaning, pest control, and home assistance services easily and securely.',
    },
    categories: {
      title: 'Categories',
      description:
        'Browse home maintenance categories, including plumbing, electricity, AC, and home appliance repair. Book a guaranteed home technician quickly.',
    },
    services: {
      title: 'Services',
    ...
    about: {
      title: 'About Us',
      description:
        'A Saudi platform specialized in connecting you with certified technicians for all home maintenance services, quickly, safely, and easily. Our goal is to give you peace of mind and ensure quality for your home.',
    },
    contact: {
      title: 'Contact Us',
      description:
        'Our team is ready to receive your message and respond as quickly as possible. Fill in the details, and we will contact you directly to assist you or fulfill your request.',
    },
    home: {
      title: 'Tashyik | Book a certified home maintenance technician in Saudi Arabia',
      description:
        'Book trusted technicians for AC, plumbing, electrical, and appliance repair across every Saudi city. Fast service, certified warranty, transparent pricing.',
    },
  },
  a11y: {
  ...
  download_app: {
    ...
    title_2: 'in one app!',
    subtitle:
      'Download the app and request the service you need at any time with complete comfort, all from your phone with a single click.',
    get_it_on: 'Get it on',
  ...
  footer: {
    ...
    copyright_suffix: 'Home maintenance services in Saudi Arabia',
  ...
  guest: {
    login: {
      title: 'Welcome!',
      subtitle: 'Enter your phone number and we will send a WhatsApp verification code.',
      sign_in: 'Send Verification Code',
    ...
    verify_otp: {
      title: 'Verify Code',
      subtitle: 'Enter the verification code sent via WhatsApp to',
      otp_label: 'Verification Code',
      verify_button: 'Verify Code',
      resend_otp: 'Resend Code',
      resend_in: 'Resend in {time}',
      expires_in: 'Code valid for {time}',
      change_phone: 'Wrong number? Change phone number',
      change_phone_submit: 'Update number and send new code',
    },
  },
  inputs: {
    email: 'Email',
  ...
  services: {
    ...
    index_subtitle:
      'Search across Tashyik services, filter by specialty, and book a certified technician without browsing categories first.',
    ...
    custom_service: {
      ...
      subtitle:
        "Couldn't find exactly what you need? Don't worry! Describe the problem, and you'll receive quotes from specialized technicians.",
  ...
  service_provider: {
    h1: {
      ...
      description:
        'Do you have skills in home services and are looking for an easy way to reach customers? Join us and start providing your services with confidence and professionalism through our specialized platform.',
    },
    h2: {
  ...
  order: {
    ...
    completion: {
      ...
      reject: 'Reject completion',
      reject_confirm: 'Are you sure you want to reject completion?',
  ...
  about: {
    hero: {
      ...
      description:
        'A Saudi platform specialized in connecting you with certified technicians for all home maintenance services, quickly, safely, and easily. Our goal is to provide peace of mind and ensure quality that suits your home.',
      subtitle: {
        part_1: 'Who',
        part_2: 'Are we?',
      },
    ...
    story: {
      title: 'Our Story',
      paragraph_1:
        'We started Tashyik with the aim of simplifying people’s lives and providing a smart solution that gathers all home maintenance services in one place. We believe that fast and reliable service begins with choosing the right technician and ends with customer satisfaction.',
      paragraph_2:
        'Our vision goes beyond just fixing faults; we seek to build a Saudi technical community that contributes to raising the quality of life inside every home in the Kingdom, by organizing maintenance services and providing them through a single application, while raising professional standards.',
    },
    features: {
      title: {
        part_1: 'Why choose',
    ...
    audience: {
      ...
      institutions: {
        title: 'Institutions',
        description:
          'We know that any minor fault can affect the workflow. That’s why we provide institutions with maintenance solutions that help them maintain business continuity without interruption, whether it’s periodic maintenance or urgent requests. We care about organization, commitment, and quality of execution every time.',
      },
      service_providers: {
        title: 'Technicians',
        description:
          'We believe the technician is the heart of the service and the basis of its success. We provide technicians with a platform that helps them reach real customers, clear order organization, and support that facilitates their daily work. Our goal is for the technician to focus on his work and grow with us step by step with confidence and stability.',
      },
    },
  },
  contact: {
    ...
    hero: {
      ...
      description:
        'Our team is ready to receive your message and respond as quickly as possible. Fill in the details, and we will contact you directly to help you or fulfill your request.',
    },
    inputs: {
      name: {
        title: 'Full Name',
  ...
  articles: {
    seo: {
      ...
      description:
        'Read the latest articles and tips about home maintenance, appliance care, and best practices to keep your home in great shape.',
    },
    hero: {
      title: 'Articles',
