export default {
  ...
  home: {
    ...
    features: {
      ...
      subtitle: 'We are proud of the trust thousands of customers place in us, because we always strive to provide a service you can rely on.',
      feature_1: {
        title: '+300',
    ...
    reviews: {
      ...
      item_1: {
        name: 'Fahad Al-Anzi',
        body: 'Excellent app! I requested an AC technician and he arrived within an hour. The work was clean and the price was very reasonable. Highly recommended! 👍',
        date: 'A week ago',
      },
      item_2: {
  ...
  download_app: {
    title: 'All your home services.. in one app!',
    ...
    highlight_1: 'Request service in seconds',
    highlight_2: 'Secure and guaranteed payment',
  ...
  service_provider: {
    ...
    h2: {
      ...
      items: ['Air Conditioning (Installation – Maintenance – Cleaning)', 'Electricity (Wiring – Repair – Appliance Installation)', 'Plumbing (Maintenance – Leak Detection – Extensions)', 'Home Appliances (Washers – Fridges – Ovens – Microwaves)', 'Carpentry (Doors – Furniture – Bedrooms – Custom)', 'Painting (Interior & Exterior – Wallpapers)', 'Satellite (Installation – Programming – Maintenance)', 'Home Cleaning (Comprehensive Cleaning – Facades – Carpets)', 'Pest Control (Safe and Effective Pesticides)', 'Home Assistance (Cleaning, Organizing, and Daily Support)'],
    },
    button: 'Register Now',
  },
  categories: {
