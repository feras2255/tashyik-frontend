export default {
  seo: {
    ...
    home: {
      title: 'Tashyik | Mag-book ng sertipikadong teknisyan sa pag-aayos ng bahay sa Saudi Arabia',
      description:
        'Mag-book ng maaasahang teknisyan sa Tashyik sa loob ng ilang minuto. Kuryente, tubero, karpintero, aircon, pintura at 1,000+ serbisyo | 90+ lungsod | 3,800+ propesyonal | 4.8⭐ | ligtas na bayad at gintong garantiya.',
    },
  },
  a11y: {
    open_user_menu: 'Buksan ang menu ng gumagamit',
    open_main_menu: 'Buksan ang pangunahing menu',
    close_menu: 'Isara ang menu',
    notifications: 'Mga Abiso',
    language: 'Wika',
    breadcrumb: 'Landas ng pahina',
    contact_whatsapp: 'Makipag-ugnayan sa WhatsApp',
    coupon_code: 'Kodigo ng kupon',
    show_password: 'Ipakita ang password',
    hide_password: 'Itago ang password',
    chatbot: 'Buksan ang chat',
  },
  common: {
    ...
    warranty: 'Garantiya ng {duration}',
    all: 'Lahat',
    wallet_balance: 'Balanse sa pitaka',
    optional: 'Opsyonal',
  ...
  home: {
    ...
    offers: {
      ...
      discount_on_service: '{percentage}% bawas sa {name}',
      free_inspection_for: 'Libreng Inspeksyon para sa {name}',
      first_order_maintenance: 'Pag-aayos ng gamit sa bahay sa unang order',
    ...
    top_rated: {
      ...
      provider_3: {
        name: 'Nangungunang Teknisyan ng Gamit sa Bahay',
        title: 'Espesyalista sa Pag-aayos ng Gamit sa Bahay',
      },
    },
    features: {
      ...
      fast_support: {
        ...
        description: 'Available ang aming team ng suporta 24/7 para sagutin ang iyong mga katanungan at lutasin ang iyong mga problema.',
      },
      clear_prices: {
        title: 'Malinaw na Presyo',
        description: 'Walang nakatagong bayad — itinakda ang mga presyo nang maaga para alam mo ang gastos bago mag-book.',
      },
      trusted_techs: {
        title: 'Pinagkakatiwalaang Teknisyan',
        description: 'Lahat ng teknisyan ay dumadaan sa masusing background check at pagsusuri sa propesyonal na kakayahan.',
      },
      instant_booking: {
        title: 'Agad na Pag-book',
        description: 'Ilang click lang at papunta na ang teknisyan mo sa iyong bahay sa napagkasunduang oras.',
      },
      real_reviews: {
        title: 'Tunay na Mga Review',
        description: 'Lahat ng rating ay mula sa mga totoong customer na talagang nakaranas ng serbisyo.',
      },
      warranty: {
        title: 'Garantiya sa Serbisyo',
        description: 'Nagbibigay kami ng garantiya hanggang 30 araw sa lahat ng natapos na serbisyo sa pagpapanatili.',
      },
    },
    newsletter: {
      title: 'Huwag palampasin ang anumang bagong alok!',
      description: 'Mag-subscribe sa aming newsletter para makatanggap ng pinakabagong mga diskwento at eksklusibong alok.',
    ...
    reviews: {
      ...
      item_1: {
        name: 'Fahad Al-Anzi',
        tag: 'Pagpapanatili',
        body: 'Napakagandang app! Tumawag ako ng teknisyan at nakarating agad. Malinis ang trabaho at makatwiran ang presyo.',
      ...
      item_3: {
        ...
        tag: 'Pagpapanatili',
        body: 'Mabilis at propesyonal na teknisyan. Natapos ang pag-aayos sa aircon nang mabilis.',
        date: 'Kahapon',
      },
      item_4: {
        name: 'Nasser Al-Otaibi',
        tag: 'Pag-aayos ng Elektrikal',
    ...
    questions: {
      title: 'Mga Tanong na Maaaring Itanong Mo!',
    },
  },
  download_app: {
    ...
    highlight_3: 'Sundan ang teknisyan',
  },
  footer: {
    description_1:
      'Mag-book ng maaasahang teknisyan sa pag-aayos ng bahay sa loob ng ilang minuto sa Tashyik! Nagbibigay kami ng mga sertipikadong teknisyan sa Saudi Arabia para sa kuryente, tubero, karpintero, aircon, pintura, at higit sa ',
    description_2:
      '1,000 serbisyo sa bahay. +3,800 propesyonal na teknisyan sa +90 lungsod | 4.8 ⭐ rating | Ligtas na bayad pagkatapos ng serbisyo at gintong garantiya sa bawat trabaho.',
    ...
    copyright_suffix: 'Mga serbisyo sa pag-aayos ng bahay sa Saudi Arabia',
    ...
    saudi_business_center: 'Verified sa Business Platform',
  ...
  navigation: {
    ...
    service_provider: 'Magrehistro bilang tagapagbigay ng serbisyo',
    profile: {
      title: 'Aking Account',
  ...
  guest: {
    ...
    register: {
      ...
      service_provider: {
        ...
        subtitle: 'Magrehistro bilang teknisyan at magsimulang tumanggap ng trabaho',
        applied: {
  ...
  chatbot: {
    title: 'Tashyik Chat',
    subtitle: 'Nandito kami para tumulong sa iyo',
    welcome: 'Maligayang pagdating! Paano kami makakatulong?',
    placeholder: 'I-type ang iyong mensahe...',
    new_chat: 'Bagong Chat',
    send: 'Ipadala',
    close: 'Isara',
    typing: 'Nagta-type...',
    error_network: 'Hindi makakonekta. Pakisuri ang iyong koneksyon at subukang muli.',
    error_server: 'May error sa server. Pakisubukan ulit mamaya.',
    error_generic: 'May hindi inaasahang error. Pakisubukan ulit.',
    retry: 'Subukan ulit',
    messages_count: 'mga mensahe',
    suggestion_1: 'Halimbawa: Puwede ba akong mag-book ng mabilis na serbisyo ng elektrisyan?',
    suggestion_2: 'Halimbawa: Paano ako hihingi ng maintenance sa AC?',
  },
} as const;
