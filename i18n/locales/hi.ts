export default {
  seo: {
    ...
    home: {
      ...
      description:
        'Tashyik के साथ मिनटों में भरोसेमंद होम मेंटेनेंस तकनीशियन बुक करें। बिजली, प्लंबिंग, बढ़ईगिरी, एचवीएसी, पेंटिंग और 1,000+ सेवाएं | 90+ शहर | 3,800+ पेशेवर | 4.8⭐ | सुरक्षित भुगतान और गोल्ड गारंटी।',
    },
  },
  a11y: {
  ...
  footer: {
    description_1:
      'Tashyik के साथ मिनटों में एक भरोसेमंद होम मेंटेनेंस तकनीशियन बुक करें! हम सऊदी अरब में बिजली, प्लंबिंग, बढ़ईगिरी, एचवीएसी, पेंटिंग और ',
    description_2:
      '1,000 से अधिक अन्य घरेलू सेवाएं प्रदान करते हैं। 90 से अधिक शहरों में 3,800+ पेशेवर तकनीशियन | 4.8 ⭐ रेटिंग | सेवा पूरी होने के बाद सुरक्षित भुगतान और हर सेवा पर गोल्ड गारंटी।',
    our_apps: 'हमारे ऐप्स',
