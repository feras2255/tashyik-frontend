export default {
  ...
  home: {
    ...
    features: {
      title: 'हजारों ग्राहक हम पर भरोसा क्यों करते हैं?',
      subtitle: 'हमें अपने ग्राहकों के भरोसे पर गर्व है क्योंकि हम हमेशा विश्वसनीय सेवा प्रदान करने का प्रयास करते हैं।',
      feature_1: {
        title: '+300',
        description: 'घरेलू सेवाएं',
      },
      feature_2: {
        title: '3,800+',
        description: 'पेशेवर तकनीशियन',
      },
      feature_3: {
        title: '632,000+',
        description: 'पूरे किए गए कार्य',
      },
      feature_4: {
        title: '25+',
        description: 'शहर कवर्ड',
      },
      feature_5: {
        title: '4.8',
        description: 'औसत ग्राहक रेटिंग',
      },
    },
    reviews: {
  ...
  service_provider: {
    ...
    h2: {
      ...
      items: ['एसी (स्थापना - रखरखाव - सफाई)', 'बिजली (वायरिंग - मरम्मत)', 'प्लंबिंग (रखरखाव - रिसाव का पता लगाना)', 'घरेलू उपकरण (वॉशिंग मशीन - फ्रिज - ओवन)', 'बढ़ईगीरी (दरवाजे - फर्नीचर)', 'पेंटिंग (आंतरिक और बाहरी)', 'सैटेलाइट (स्थापना - प्रोग्रामिंग)', 'घर की सफाई', 'कीट नियंत्रण', 'घरेलू सहायता'],
    },
